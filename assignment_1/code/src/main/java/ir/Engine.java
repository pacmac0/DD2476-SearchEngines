...
public class Engine {
    ...
    /** K-gram index */
    KGramIndex kgIndex = new KGramIndex(2); // TODO change here K value of k-gram index
    ...
    public Engine( String[] args ) {
        ...
        if (is_indexing) {
            synchronized ( indexLock ) {
                ...
                System.out.println("Finished file processing");
                
                // compute idf from 2.3
                //indexer.getSpecificIdfs();
                // print k-gram entries for 3.3
                //indexer.kgIndex.printSpecificEntries();
                
                try {
                    indexer.computeDocLength();
                    System.out.println("Vector length calculated");
                } catch (Exception e) {
                    System.err.println("Error calculating euclidean document length");
                    e.printStackTrace();
                }
