...
public class Query {
    ...
    // add a Query to the queryterm ArrayList<QueryTerm>
    public void addQueries(Query term) {
        for (QueryTerm qtElem : term.queryterm) {
            this.queryterm.add(qtElem);   
        }
    }

    // add a term to the queryterm ArrayList<QueryTerm>
    public void addToken(String token) {
        QueryTerm qt = new QueryTerm(token, 1.0);
        this.queryterm.add(qt);
    }
